...
function getDistrict() {
    ...
    $.ajax({
        url: "/info/area/getAreaByCityCode?cityCode=" + $("#city").val(),
        type: "GET",
        dataType: "json",
        success: function (data) {
            if (data.data != null) {
...
function getCity() {
    ...
    $.ajax({
        url: "/info/city/getCityByProvinceCode?provinceCode=" + $("#province").val(),
        type: "GET",
        dataType: "json",
        success: function (data) {
            if (data.data != null) {
