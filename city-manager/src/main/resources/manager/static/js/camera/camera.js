function addOrUpdateCamera() {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: '/city-manager/camera/feign/' + address,
...
$(function () {
    $('#cameraTable').bootstrapTable({
        ajax: function (request) {
            $.ajax({
                type: "GET",
                url: "/city-manager/camera/feign/allCamera",
...
function deleteCamera(cameraId) {
    swal({
        ...
        if (isConfirm) {
            ...
            $.ajax({
                url: "/city-manager/manager/menu/deleteMenuById/" + cameraId,
                method: 'get',
                success: function () {
                    swal.close();
...
function getArea() {
    ...
    $.ajax({
        url: "/city-manager/info/feign/getAreaByCityCode?cityCode=" + $("#city").val(),
        type: "GET",
        dataType: "json",
        success: function (data) {
            if (data.data != null) {
...
function getCity() {
    ...
    $.ajax({
        url: "/city-manager/info/feign/getCityByProvinceCode?provinceCode=" + $("#province").val(),
        type: "GET",
        dataType: "json",
        success: function (data) {
            if (data.data != null) {
